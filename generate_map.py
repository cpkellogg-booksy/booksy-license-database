...
def add_booksy_interface(file_path):
    ...
    # SVG ICONS (Hardcoded to prevent loading errors)
    ...
    # RAW HTML TEMPLATE (No f-strings here means no syntax errors!)
    html_template = """
    <style>
    ...
    <div id="landing-page">
        <div class="hero-content">
            ...
            <div class="card-grid">
                <a href="__GEMINI_LINK__" target="_blank" class="card">
                    <div class="icon-box">__ICON_GEMINI__</div>
                    <h3>Ask Gemini</h3>
                    <p>AI Market Analysis</p>
                </a>
                
                <div class="card" onclick="enterMap()">
                    <div class="icon-box">__ICON_MAP__</div>
                    <h3>Launch Map</h3>
                    <p>Explore 275k+ Licenses</p>
                </div>

                <a href="__SQL_LINK__" target="_blank" class="card">
                    <div class="icon-box">__ICON_LOCK__</div>
                    <h3>Data Vault</h3>
    ...
    <div id="control-dock">
        ...
        <a href="__GEMINI_LINK__" target="_blank" class="dock-btn">Gemini</a>
        <a href="__SQL_LINK__" target="_blank" class="dock-btn">DB Console</a>
    </div>
    ...
    # 2. INJECT VARIABLES SAFELY
    interface_html = html_template.replace("__GEMINI_LINK__", GEMINI_LINK)
    interface_html = interface_html.replace("__SQL_LINK__", SQL_LINK)
    interface_html = interface_html.replace("__ICON_GEMINI__", ICON_GEMINI)
    interface_html = interface_html.replace("__ICON_MAP__", ICON_MAP)
    interface_html = interface_html.replace("__ICON_LOCK__", ICON_LOCK)
